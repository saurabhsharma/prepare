   <!--mini statistics start-->
                ...
                <div class="panel-body">
                    <div class="top-stats-panel">
                        <div class="daily-visit">
                            <h4 class="widget-h">Daily Vistors</h4>
                ...
                <div class="panel-body">
                    <div class="top-stats-panel">
                        ...
                        <div class="bar-stats">
                            ...
                            <ul class="bar-legend">
                                <li><span class="bar-legend-pointer pink"></span> New Your</li>
    ...
    <div class="row">
        <div class="col-md-8">
            <section class="panel">
                <div class="wdgt-row">
                    <img src="<?php echo $this->webroot; ?>assets/admin/images/weather_img.png" height="243" alt="">
                    <div class="wdt-head">
                        weather forecast
                    </div>
